...
public:
	...
	virtual void SetWinningTeam( int team, int iWinReason, bool bForceMapReset = true, bool bSwitchTeams = false ) { return; }
	virtual void SetStalemate( bool bForceMapReset ) { return; }
