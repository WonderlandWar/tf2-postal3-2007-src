...
public:
    ...
    void TeamFortress_RemoveBuildings();
	...
	CHintSystem *Hints() { return &m_Hints; }
...
public:
	...
	void				SetActivePipebombs( int iActivePipebombs ) { m_iActivePipebombs = iActivePipebombs; }
...
private:
	...
	void				StateEnterWATCHINGROUNDINFO();
...
private:
	...
	CNetworkVar( int, m_iActivePipebombs );
